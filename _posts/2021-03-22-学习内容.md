...
## 记录错误markdown中的The page build failed for the `main` branch with the following error:

The variable `{{1,0}` on line 35 in `_posts/2021-03-22-学习内容.md` was not properly closed with `}}`大括号不兼容要注意
